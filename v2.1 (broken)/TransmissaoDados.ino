...
volatile int vemDado = 0; //r
volatile int caracbit = 0; 
volatile int bites[8]={0,0,0,0,0,0,0,0}; //r
volatile int nextCaracterCount = 0; 
volatile int bitEsperadoNoPareamento = 3; //r

volatile bool prontoParaReceber = false; //r
volatile bool prontoParaEnviar = false; //e
volatile bool interrupcao = false; //r

volatile char caracterParaEnvio = 'U'; //e
...
void IRAM_ATTR onEnvTimer() {
  ...
  Serial.println(caracterParaEnvio);
